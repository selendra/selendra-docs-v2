...
To Install and build Selendra-Chain see [here](/documents/maintain/fullnode/source).
...
To run Selendra-Chain with docker see [here](/documents/maintain/fullnode/docker).
